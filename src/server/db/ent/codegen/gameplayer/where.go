...
func UserIDNEQ(v int) predicate.GamePlayer {
	return predicate.GamePlayer(sql.FieldNEQ(FieldUserID, v))
}

// UserIDIn applies the In predicate on the "user_id" field.
func UserIDIn(vs ...int) predicate.GamePlayer {
	return predicate.GamePlayer(sql.FieldIn(FieldUserID, vs...))
}

// UserIDNotIn applies the NotIn predicate on the "user_id" field.
func UserIDNotIn(vs ...int) predicate.GamePlayer {
...
func GameIDNEQ(v int) predicate.GamePlayer {
	return predicate.GamePlayer(sql.FieldNEQ(FieldGameID, v))
}

// GameIDIn applies the In predicate on the "game_id" field.
func GameIDIn(vs ...int) predicate.GamePlayer {
	return predicate.GamePlayer(sql.FieldIn(FieldGameID, vs...))
}
...
func HasUser() predicate.GamePlayer {
...
func HasUserWith(preds ...predicate.User) predicate.GamePlayer {
	return predicate.GamePlayer(func(s *sql.Selector) {
		step := newUserStep()
...
func HasGame() predicate.GamePlayer {
	return predicate.GamePlayer(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasGameWith(preds ...predicate.Game) predicate.GamePlayer {
	return predicate.GamePlayer(func(s *sql.Selector) {
		step := newGameStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func And(predicates ...predicate.GamePlayer) predicate.GamePlayer {
	return predicate.GamePlayer(sql.AndPredicates(predicates...))
}

// Or groups predicates with the OR operator between them.
func Or(predicates ...predicate.GamePlayer) predicate.GamePlayer {
	return predicate.GamePlayer(sql.OrPredicates(predicates...))
}

// Not applies the not operator on the given predicate.
func Not(p predicate.GamePlayer) predicate.GamePlayer {
	return predicate.GamePlayer(sql.NotPredicates(p))
}
